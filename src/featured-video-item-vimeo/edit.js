...
const Edit = (props) => {
	...
	return (
		<>
			...
			<InspectorControls>
				<PanelBody
					title={__('Multiple Featured Video Item - Vimeo', 'featured-video')}
					initialOpen={true}
				>
					<PanelRow>
						<fieldset>
							<MediaUploadCheck>
								<MediaUpload
									...
									allowedTypes="image"
									value={mediaID}
									help={__('Optional', 'featured-video-item-vimeo')}
									render={({ open }) => (
										<Button
											className={
			...
			<div className="video-col col-12 col-lg-4">
				<div {...blockProps} >
					<a href={'https://player.vimeo.com/video/' + embedUrl + '?autoplay=1&rel=0'} className="video-wrapper"

			...
			<section className="featured-video">
				<div className="container-fluid single-video-container">
					<div className="row align-items-start">
						<a href={ 'https://www.youtube.com/embed/' + youtubeEmbed + '?autoplay=1&rel=0'} className="video-wrapper" aria-label={`Play video: ${title || 'featured video'}`} data-toggle="lightbox" onClick={onLinkClick}>
							<div className="video-play" role="button">

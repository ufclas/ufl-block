				...
				<div className="container-fluid single-video-container">
					<div className="row align-items-start">
						{mediaURL ? (
							...
							<a href={ 'https://www.youtube.com/embed/' + youtubeEmbed + '?autoplay=1&rel=0'} className="video-wrapper" aria-label={`Play video: ${title || 'featured video'}`} data-toggle="lightbox">
								<div className="video-play" aria-hidden="true" role="button">
